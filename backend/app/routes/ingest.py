...
# Notice how we are importing the Logic you just moved to the services folder!
...
async def upload_pdf(
    ...
    try:
        # 2. Vector Storage: Update the FAISS AI Brain using your Service
        ...
        new_doc = Document(
            ...
            department=department # Saving the real department
        )
        db.add(new_doc)
        db.commit()
